...
console.log(heading.parentNode);//body

// childNodes : return all the child nodes of the specified node

console.log("childrenNodes", wrapperEle.childNodes);// returns NodeList (including text nodes)
...
const firstChildofWrapper = wrapperEle.firstElementChild;
firstChildofWrapper.style.color ="green";
